...
public class ImagePHash {
    ...
    private final ColorConvertOp COLOR_CONVERT_OP = new ColorConvertOp(ColorSpace.getInstance(ColorSpace.CS_GRAY), null);
    ...
    private BufferedImage grayscale(BufferedImage img) {
        COLOR_CONVERT_OP.filter(img, img);
        return img;
    }
